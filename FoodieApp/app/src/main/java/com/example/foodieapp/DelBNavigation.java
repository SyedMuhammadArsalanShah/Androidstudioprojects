...
import com.example.foodieapp.deliveryfoodpanel.DeliveryPendingOrderFragment;
import com.example.foodieapp.deliveryfoodpanel.DeliveryShipOrderFragment;
...
public class DelBNavigation extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_del_bnavigation);

...
import com.example.foodieapp.SendNotification.APIService;
import com.example.foodieapp.SendNotification.Client;
import com.example.foodieapp.SendNotification.Data;
import com.example.foodieapp.SendNotification.MyResponse;
import com.example.foodieapp.SendNotification.NotificationSender;
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        dialog.dismiss();
                                        Intent intent = new Intent(Delivery_ShippingOrder.this, DelBNavigation.class);
